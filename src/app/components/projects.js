              ...
              <SpotlightCard className="w-full group">
                <div className="flex flex-col md:flex-row items-center gap-6 md:gap-14">
                  ...
                  <div className="text-white space-y-3 md:pr-20">
                    ...
                    <button className="flex justify-center items-center gap-2 backdrop-blur-lg h-9 bg-white/10 border border-white/40 rounded-lg px-6 py-2 shadow-md hover:scale-105 transition-transform duration-300">
